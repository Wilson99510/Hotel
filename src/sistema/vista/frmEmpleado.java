 ...
 * @author wcaba
 */
public class frmEmpleado extends javax.swing.JInternalFrame { //El JInternalFrame es para que frmhabitaciones aparezca dentro del Escritorio
    ...
    void deshabilitar(){      //metodo para deshabilitar botones
        ...
        cboAcceso_sistema.setEnabled(false);
        txtUsuario.setEnabled(false);
        txtContraseña.setEnabled(false);
        cboEstado_cuenta.setEnabled(false);
    ...
    void habilitar(){       //metodo para habilitar botones
        ...
        cboAcceso_sistema.setEnabled(true);
        txtUsuario.setEnabled(true);
        txtContraseña.setEnabled(true);
        cboEstado_cuenta.setEnabled(true);
    ...
    void mostrar (String buscar){
        try {
            ...
            ctlempleado funcion= new ctlempleado();
    ...
    private void initComponents() {
        ...
        cboAcceso_sistema = new javax.swing.JComboBox<>();
        cboEstado_cuenta = new javax.swing.JComboBox<>();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "REGISTRO DE EMPLEADOS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        txtSueldo.setBackground(new java.awt.Color(102, 102, 102));
        ...
        jLabel13.setText("Acceso al Sistema:");
        ...
        cboAcceso_sistema.setBackground(new java.awt.Color(102, 102, 102));
        cboAcceso_sistema.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        cboAcceso_sistema.setForeground(new java.awt.Color(255, 255, 255));
        cboAcceso_sistema.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ADMINISTRADOR", "FUNCIONARIO" }));
        cboAcceso_sistema.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboAcceso_sistemaActionPerformed(evt);
            }
        });

        cboEstado_cuenta.setBackground(new java.awt.Color(102, 102, 102));
        cboEstado_cuenta.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        cboEstado_cuenta.setForeground(new java.awt.Color(255, 255, 255));
        cboEstado_cuenta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "D" }));
        cboEstado_cuenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboEstado_cuentaActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(cboAcceso_sistema, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                                .addComponent(cboEstado_cuenta, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(108, 108, 108)))))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel13)
                    .addComponent(cboAcceso_sistema, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel16)
                    .addComponent(cboEstado_cuenta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "LISTADO DE EMPLEADOS", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtNombre.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Nombre del Empleado");
            txtNombre.requestFocus();
            return;
        }

        if (txtApellido.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Apellido del Empleado");
            txtApellido.requestFocus();
            return;
        }

        if (txtNumero_documento.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Numero de Documento del Empleado");
            txtNumero_documento.requestFocus();
            return;
        }
        
        if (txtSueldo.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Sueldo del Empleado");
            txtSueldo.requestFocus();
            return;
        }
        
        if (txtUsuario.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Usuario del Empleado");
            txtUsuario.requestFocus();
            return;
        }
        
        if (txtContraseña.getText().length()== 0){
            JOptionPane.showConfirmDialog(rootPane, "Ingresar Contraseña del Empleado");
            txtContraseña.requestFocus();
            return;
        }

        empleado dts = new empleado();  //instanciamos la clase empleado para crear un nuevo objeto
        ctlempleado funcion = new ctlempleado();    //instanciamos la clase ctlempleado para llamar a todas las funciones
        ...
        seleccionado=cboAcceso_sistema.getSelectedIndex();
        dts.setAcceso_sistema((String)cboAcceso_sistema.getItemAt(seleccionado));
        
        dts.setUsuario(txtUsuario.getText());
        dts.setContraseña(txtContraseña.getText());
        
        seleccionado=cboEstado_cuenta.getSelectedIndex();       //almacena el index seleccionado
        dts.setEstado_cuenta((String)cboEstado_cuenta.getItemAt(seleccionado));
        ...
        if  (accion.equals("guardar")){     //usamos el equals para comparar cadena de caracteres
            ...
            dts.setIdpersona(Integer.parseInt(txtIdpersona.getText())); //Se convierte a entero por la incompatibilidad de variables
    ...
    private void tablalistadoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMouseClicked
        ...
        cboAcceso_sistema.setSelectedItem(tablalistado.getValueAt(fila, 9).toString());
        ...
        cboEstado_cuenta.setSelectedItem(tablalistado.getValueAt(fila, 12).toString());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        if(!txtIdpersona.getText().equals("")) { // si no es igual a (espacio en blanco) se procede a eliminar el empleado
    ...
    private void cboAcceso_sistemaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboAcceso_sistemaActionPerformed
        // TODO add your handling code here:
        cboAcceso_sistema.transferFocus();
    }//GEN-LAST:event_cboAcceso_sistemaActionPerformed

    private void cboEstado_cuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboEstado_cuentaActionPerformed
        // TODO add your handling code here:
        cboEstado_cuenta.transferFocus();
    }//GEN-LAST:event_cboEstado_cuentaActionPerformed
    ...
    private javax.swing.JComboBox<String> cboAcceso_sistema;
    public javax.swing.JComboBox<String> cboEstado_cuenta;
