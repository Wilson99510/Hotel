 ...
 * @author wcaba
 */
public class frmVistaHabitaciones extends javax.swing.JFrame {

    /**
     * Creates new form frmVistaHabitaciones
     */
    public frmVistaHabitaciones() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        // TODO add your handling code here:
        if (evt.getClickCount()==2) {               //Si la cantidad de click es igual a 2 devuelve los valores
            int fila=tablalistado.getSelectedRow(); //Recoge la fila seleccionada en la tabla listado
            String codigo;  //Declaro una variable para almacenar el codigo
            String valor;   //Declaro una variable para almacenar el valor
            codigo=tablalistado.getValueAt(fila, 0).toString(); //columna 0 ya que es de idhabitacion
            valor=tablalistado.getValueAt(fila, 1).toString();  //columna 1 ya que es de numero_habitacion
            
            frmReserva.txtIdhabitacion.setText(codigo);
            frmReserva.txtNumero_habitacion.setText(valor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmVistaHabitaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmVistaHabitaciones().setVisible(true);
            }
        });
    }
